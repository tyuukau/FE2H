...
def get_config():
    ...
    parser.add_argument("--checkpoint_dir", default='../../data/checkpoints/qa_base_20211022_with_entity_wo_question_entity_dim_10_wi_context_mask', type=str,
                        help="The  checkpoints and predictions will be used.")
    ...
    parser.add_argument("--test_file", default='../../data/hotpot_data/hotpot_dev_labeled_data_v3.json', type=str,
                        help="SQuAD json for training. E.g., train-v1.1.json")
